  ...
  kz: {
    translation: {
      ...
      menu: {
        ...
        deliveryTime: "Жеткізу мерзімдері мен шарттары",
        cargoResponsibility: "Жүктің сақталуына жауапкершілік",
        home: "Басты бет",
  ...
  ru: {
    translation: {
      ...
      menu: {
        ...
        deliveryTime: "Сроки доставки и условия",
        cargoResponsibility: "Ответственность за сохранность груза",
        home: "Главная",
        parcels: "Посылки",
        profile: "Профиль",
